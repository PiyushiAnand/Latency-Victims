...
public:
    ...
    bool conf;
//     bool confidence_bit;
//     int filter_cnt; // Temporarily holds smaller ref counts
//     int sat_cnt;    // Saturating counter

    HistoryTableEntry() 
        : ref_count_threshold(0){}
};

extern std::unordered_map<IntPtr, HistoryTableEntry> history_table;
...
class Cache : public CacheBase
{
   ...
   public:
      ...
      bool hasExpired(CacheBlockInfo* block, SubsecondTime now);
